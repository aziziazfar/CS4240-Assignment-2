...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Throwable : MonoBehaviour
    {
        ...
        protected virtual void OnAttachedToHand(Hand hand)
        {
            ...
            //Debug.Log(hand.shootingAction.GetStateDown(hand.handType));
            // Debug.Log(hand.handType);
            // Debug.Log("Right Hand " + hand.handType.ToString());
        ...
        protected virtual void HandAttachedUpdate(Hand hand)
        {
            ...
            //Debug.Log(hand.handType.ToString() + " Pinch?: " + hand.grabPinchAction.GetStateDown(hand.handType));
            Debug.Log(hand.handType.ToString() + " Shoot?: " + hand.shootingAction.GetStateDown(hand.handType));
            if (hand.handType.ToString() == "RightHand" && hand.shootingAction.GetStateDown(hand.handType))
            {
                Debug.Log("SHOOT TRIGGERED" + hand.handType);
                attached = false;

                hand.DetachObject(gameObject, restoreOriginalParent);
				//GameObject handPoint = hand.objectAttachmentPoint; // trying to Obtain the hand direction
                rigidbody.velocity = hand.objectAttachmentPoint.forward * shootingSpeed;

                mAudioSrc = GetComponent<AudioSource>();
                mAudioSrc.Play();
				
				// trying to Obtain the object direction
                //igidbody.velocity = transform.forward * shootingSpeed;
